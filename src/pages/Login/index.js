...
export const Login = () => {
    ...
    const handleRegister = async () => {
        ...
        try {
            await api
                .post(
                    `/api/user/validatePassword?email=${email}&password=${password}`
                )
                .then((data) => setIsRegistered(data.data));
        } catch (error) {
                ...
                <article className="login-container">
                    ...
                    <form className="input-container">
                        ...
                        <div
                            ...
                            onClick={() =>
                                setStatusRedefinePassword(
                                    statusRedefinePassword === "closed"
                                        ? "open"
                                        : "closed"
                                )
                            }
